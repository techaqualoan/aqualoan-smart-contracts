```diff
diff --git a/reports/AaveTokenV2_layout.md b/reports/AquaTokenV3_layout.md
index 0936f3f..964f7da 100644
--- a/reports/AaveTokenV2_layout.md
+++ b/reports/AquaTokenV3_layout.md
@@ -1,19 +1,16 @@
...
+| Name                                | Type                                                            | Slot | Offset | Bytes | Contract                        |
+|-------------------------------------|-----------------------------------------------------------------|------|--------|-------|---------------------------------|
+| _balances                           | mapping(address => struct BaseAaveToken.DelegationAwareBalance) | 0    | 0      | 32    | src/AquaTokenV3.sol:AquaTokenV3 |
+| _allowances                         | mapping(address => mapping(address => uint256))                 | 1    | 0      | 32    | src/AquaTokenV3.sol:AquaTokenV3 |
+| _totalSupply                        | uint256                                                         | 2    | 0      | 32    | src/AquaTokenV3.sol:AquaTokenV3 |
+| _name                               | string                                                          | 3    | 0      | 32    | src/AquaTokenV3.sol:AquaTokenV3 |
+| _symbol                             | string                                                          | 4    | 0      | 32    | src/AquaTokenV3.sol:AquaTokenV3 |
+| ______DEPRECATED_OLD_ERC20_DECIMALS | uint8                                                           | 5    | 0      | 1     | src/AquaTokenV3.sol:AquaTokenV3 |
+| lastInitializedRevision             | uint256                                                         | 6    | 0      | 32    | src/AquaTokenV3.sol:AquaTokenV3 |
+| ______gap                           | uint256[50]                                                     | 7    | 0      | 1600  | src/AquaTokenV3.sol:AquaTokenV3 |
+| _nonces                             | mapping(address => uint256)                                     | 57   | 0      | 32    | src/AquaTokenV3.sol:AquaTokenV3 |
+| ______DEPRECATED_FROM_AAVE_V1       | uint256[3]                                                      | 58   | 0      | 96    | src/AquaTokenV3.sol:AquaTokenV3 |
+| __DEPRECATED_DOMAIN_SEPARATOR       | bytes32                                                         | 61   | 0      | 32    | src/AquaTokenV3.sol:AquaTokenV3 |
+| ______DEPRECATED_FROM_AAVE_V2       | uint256[4]                                                      | 62   | 0      | 128   | src/AquaTokenV3.sol:AquaTokenV3 |
+| _votingDelegatee                    | mapping(address => address)                                     | 66   | 0      | 32    | src/AquaTokenV3.sol:AquaTokenV3 |
+| _propositionDelegatee               | mapping(address => address)                                     | 67   | 0      | 32    | src/AquaTokenV3.sol:AquaTokenV3 |
```
